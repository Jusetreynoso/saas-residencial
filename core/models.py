...
class FacturaSaaS(models.Model):
    ...
    residencial = models.ForeignKey(Residencial, on_delete=models.CASCADE, related_name='facturas_saas')
    suscripcion = models.ForeignKey(SuscripcionResidencial, on_delete=models.SET_NULL, null=True)
    concepto = models.CharField(max_length=200, help_text="Ej: Mensualidad SaaS - Mayo 2026")
    monto = models.DecimalField(max_digits=10, decimal_places=2)
